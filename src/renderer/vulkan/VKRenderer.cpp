...
//// DRAW
void VKRenderer::draw(std::vector<Renderable> *renderables) {
...
void VKRenderer::drawRenderables(std::vector<Renderable> *renderables) {
    SE_INTERNAL_ASSERT_WITH_MSG(_RENDERER_, isInit,
                                "Renderer is not initialised, initialise before calling rendering functions")
...
void VKRenderer::initLogicalDevice() {
...
void VKRenderer::initCameraBuffers() {
...
void VKRenderer::updateCameraBuffer(const CameraBuffer &camData) {
...
void VKRenderer::initCameraDescriptors() {
    // Descriptor set
...
void VKRenderer::setQueueFamilyIndices() {
...
void VKRenderer::initPhysicalDevice() {
...
bool VKRenderer::checkInstanceExtensionSupport(const std::vector<const char *> &checkExtensions) {
...
bool VKRenderer::checkDeviceExtensionSupport(vk::PhysicalDevice pPhysicalDevice) {
...
bool VKRenderer::checkDeviceSuitable(vk::PhysicalDevice pPhysicalDevice) {
...
vk::ImageView VKRenderer::createImageView(vk::Image image, vk::Format format, vk::ImageAspectFlags aspectFlags) {
...
vk::Format VKRenderer::findSupportedFormat(const std::vector<vk::Format> &candidates, vk::ImageTiling tiling,
...
void VKRenderer::loadMeshes(std::vector<Renderable> *renderables) {
...
void VKRenderer::initVertexBuffer() {
...
void VKRenderer::initIndexBuffer(std::vector<vk::MemoryPropertyFlagBits> flags, vk::DeviceSize size) {
...
uint32_t VKRenderer::getMemoryTypeIndex(const std::vector<vk::MemoryPropertyFlagBits> &flags) {
